...
@dg.asset(name="train_join_table", required_resource_keys={"db"})
def train_join_table(context: dg.AssetExecutionContext, train_features_table: str, labels_table: str) -> str:
